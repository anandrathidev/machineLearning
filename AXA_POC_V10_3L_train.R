...
trainProbsAll <- data.frame( svmNON=train_prob_svm$NON, svmOUI=train_prob_svm$OUI,
                             ...
                             KNNNON=train_prob_KNN$NON, KNNOUI=train_prob_KNN$OUI,
...
pred_list <- list(SVM=pred_svm, C5=pred_c5, LB=pred_LB, RF=pred_RF, GBM=pred_GBM, DNN=pred_DNN, KNN=pred_KNN)
...
predProbsAll <- data.frame(  svmNON=pred_prob_svm$NON, svmOUI=pred_prob_svm$OUI, 
                             ...
                             KNNNON=pred_prob_KNN$NON, KNNOUI=pred_prob_KNN$OUI,
...
#RtrainProbsAllOUI3RD_NB <- data.frame(Max = predProbsAllOUI2$Final, Mean = predProbsAllOUI2$Mean, MeanMax = predProbsAllOUI2$NewFinal)
#RtrainProbsAllOUI3RD_NB$Class <- y
...
NB3RDdf_Mean <- data.frame(NB = (pred_Prob_NB3RD$OUI - pred_Prob_NB3RD$NON)  , 
