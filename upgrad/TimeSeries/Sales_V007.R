...
resDFWhole <- as.data.frame(cbind(YrMon=rownames(EU.Consumer.Sales.forcast_12_df),
                             EU.Consumer.Sales = as.numeric(EU.Consumer.Sales.forcast_12_df$`Point Forecast`), 
                             EU.Consumer.Quantity = as.numeric(EU.Consumer.Quantity.forcast_12_df$`Point Forecast`),
                             EU.Corporate.Sales = as.numeric(EU.Corporate.Sales.forcast_12_df$`Point Forecast`),
                             EU.Corporate.Quantity = as.numeric(EU.Corporate.Quantity.forcast_12_df$`Point Forecast`),
                             APAC.Consumer.Sales = as.numeric(APAC.Consumer.Sales.forcast_12_df$`Point Forecast`), 
                             APAC.Consumer.Quantity = as.numeric(APAC.Consumer.Quantity.forcast_12_df$`Point Forecast`),
                             APAC.Corporate.Sales = as.numeric(APAC.Corporate.Sales.forcast_12_df$`Point Forecast`), 
                             APAC.Corporate.Quantity = as.numeric(APAC.Corporate.Quantity.forcast_12_df$`Point Forecast`),
                             LATAM.Consumer.Sales = as.numeric(LATAM.Consumer.Sales.forcast_12_df$`Point Forecast`),
                             LATAM.Consumer.Quantity = as.numeric(LATAM.Consumer.Quantity.forcast_12_df$`Point Forecast`)) 
...
resDF <- resDF[which(as.yearmon(resDFWhole$YrMon) > as.yearmon('Dec 2014') ), ]
